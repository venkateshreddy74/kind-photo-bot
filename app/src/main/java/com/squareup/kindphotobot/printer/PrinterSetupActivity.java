...
import com.squareup.kindphotobot.oauth.OAuthActivity;
import com.squareup.kindphotobot.util.ParentActivity;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

public class PrinterSetupActivity extends ParentActivity {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    findViewById(R.id.oauth_button).setOnClickListener(
        v -> startActivity(new Intent(PrinterSetupActivity.this, OAuthActivity.class)));
