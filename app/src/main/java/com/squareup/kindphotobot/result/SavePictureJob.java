...
import com.squareup.kindphotobot.printer.PrintJob;
import com.squareup.kindphotobot.twitter.Tweeter;
import com.squareup.kindphotobot.twitter.UploadTweetPictureJob;
...
public class SavePictureJob extends Job {
  ...
  public SavePictureJob(App app, Bitmap bitmap, String message, boolean cloudPrint) {
  ...
  private void saveToDevice(Bitmap bitmap) throws IOException {
    ...
    String imageFileName = "photobooth_" + timeStamp + ".jpeg";
